...
function About() {
    return (
        ...
        <td id='p-p0'>I’m an engineering graduate looking for an entry-level software  or cloud engineer position to start my career and to take on a challenging role to develop my skills and knowledge</td>
        </tr>       
        <tr>
